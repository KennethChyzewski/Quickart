...
class DetailedPost extends React.Component {
    ...
    render(){
        ...
        <section className='mainBackground'>
            <div class="containerDetailedPosts">
                ...
                <div class="posts">
                    <div class="infomationColour" >
                        <div>
                            <h4 class='textDefaultColor'>Product Info/Description</h4>
                            <p class="paragraphColour">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>

                            <h4 class='textDefaultColor'>PickUp/Delivery Options </h4>
                            <p class="paragraphColour">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.
                            </p>
                        </div>

                        <h4 class='textDefaultColor'> Pictures </h4>
                ...
                <div class="'">
                    ...
                    <div class="informationColour">
                        ...
                        <div class='tagBar'>
                        <h4 class='textDefaultColor'> Tags </h4>
